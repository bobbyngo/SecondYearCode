class BinaryHeap:
    """The implementation of a max-heap from "Problem Solving with Algorithms
    ...
    def get_max(self) -> int:
        """Return the biggest item in this heap.
...
# time complexity of insert element: max_heap O(1) to O(log n)


# deleting node: delete the root first and swap with the last element  O(logn)
# max heap and stores those nodes in the array will have the ascending order list
#Heap is a complete binary tree


#Heap sort: nlogn

#Heapify: O(n) look down



#Priority Queue: Implmented by heap (logn)